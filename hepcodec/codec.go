// Package hepcodec implements HEP3 wire encoding and decoding used by SIP/media export.
package hepcodec
...
const (
	ProtocolSIP        = 0x01
	ProtocolRTCP       = 0x05
	ProtocolRTPReport  = 0x22
	ProtocolRTCPReport = 0x24
	ProtocolDTMF       = 0x64
...
// TransportProtocol maps gossipper transport names to HEP IP protocol values.
